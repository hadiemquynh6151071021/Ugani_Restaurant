...
CREATE TABLE CHITIETDATMONAN(
	...
	CONSTRAINT RBTV_PK_DANHSACHMONAN PRIMARY KEY(STT),
...
CREATE TABLE CHITIETDATBAN(
	...
	CONSTRAINT RBTV_PK_DANHSACHBANAN PRIMARY KEY(STT),
...
(N'96a25676-b8c2-4682-9952-12022f8719e8','AV1-2','2023-04-15','2023-04-20 09:00:00','2023-04-20 11:00:00'),
(N'96a25676-b8c2-4682-9952-12022f8719e8','AV2-2','2023-04-15','2023-04-20 09:00:00','2023-04-20 11:00:00'),
(N'ca72cff3-34e4-4ce7-9098-2903f4ccfab8','AV1-4','2023-04-16','2023-04-20 19:00:00','2023-04-20 21:00:00'),
(N'ca72cff3-34e4-4ce7-9098-2903f4ccfab8','AV2-4','2023-04-16','2023-04-20 19:00:00','2023-04-20 21:00:00');

INSERT INTO CHITIETDATMONAN VALUES
(N'96a25676-b8c2-4682-9952-12022f8719e8',1,4,'2023-04-15'),
(N'96a25676-b8c2-4682-9952-12022f8719e8',18,4,'2023-04-15'),
(N'96a25676-b8c2-4682-9952-12022f8719e8',24,4,'2023-04-15'),
(N'96a25676-b8c2-4682-9952-12022f8719e8',32,4,'2023-04-15'),
(N'ca72cff3-34e4-4ce7-9098-2903f4ccfab8',2,8,'2023-04-15'),
(N'ca72cff3-34e4-4ce7-9098-2903f4ccfab8',19,8,'2023-04-15'),
(N'ca72cff3-34e4-4ce7-9098-2903f4ccfab8',25,8,'2023-04-15'),
(N'ca72cff3-34e4-4ce7-9098-2903f4ccfab8',31,8,'2023-04-15');

INSERT INTO HOADON VALUES
(N'96a25676-b8c2-4682-9952-12022f8719e8','2023-04-15',1632000,N'Đang xử lý'),
(N'ca72cff3-34e4-4ce7-9098-2903f4ccfab8','2023-04-15',3016000,N'Đang xử lý');

CREATE PROCEDURE Sp_Statistical_Bill @Year INT
AS
BEGIN
	SELECT MONTH(HOADON.NGAYDATCOC) AS MONTH,COUNT(MAKH) AS TOTAL
	FROM HOADON
	WHERE YEAR(HOADON.NGAYDATCOC)=@Year
	GROUP BY MONTH(HOADON.NGAYDATCOC)
END
